...
1. # 확장 팩 설치
   Extension 설치   
   <img src="../../imgs/mysql/extension_mysql.png" style="border:3px solid black;border-radius:9px;width:700px">   
   ...
   <img src="../../imgs/mysql/extension_mysql3.png" style="border:3px solid black;border-radius:9px;width:600px">   
   입력 값들을 save 해놓을 수도 있습니다.   

   왼쪽 Explorer 탭에서 연결 확인   
   <img src="../../imgs/mysql/extension_mysql4.png" style="border:3px solid black;border-radius:9px;width:400px">   

   연결이 되면 기존 프로젝트의 sql확장자 파일에 다음과 같은 실행 커멘트가 자동으로 나타납니다.   
   <img src="../../imgs/mysql/extension_mysql5.png" style="border:3px solid black;border-radius:9px;width:800px">   
