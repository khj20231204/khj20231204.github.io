...
1. # Naver Email 설정
   ...
   로그인 후 환경 설정으로 이동   
   <img src="../../../imgs/LESSON/SPRING(Lesson)/email_2(setting).png" style="border:3px solid black;border-radius:9px;width:400px">   

   POP3를 사용 설정   
   <img src="../../../imgs/LESSON/SPRING(Lesson)/email_3(pop3).png" style="border:3px solid black;border-radius:9px;width:800px">  

   IMap 사용 설정
   <img src="../../../imgs/LESSON/SPRING(Lesson)/email_4(imap).png" style="border:3px solid black;border-radius:9px;width:800px">  

   포트 번호를 알아둡니다.
   <img src="../../../imgs/LESSON/SPRING(Lesson)/email_4(port number).png" style="border:3px solid black;border-radius:9px;width:800px">  
