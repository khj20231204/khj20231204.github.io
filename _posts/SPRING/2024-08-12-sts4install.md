...
1. # 설치
   ...
   <img src="../../imgs/spring/install_2.png" style="border:3px solid black;border-radius:9px;width:600px">   
   ...
   <img src="../../imgs/spring/install_3.png" style="border:3px solid black;border-radius:9px;width:600px">   
...
1. # STS4에서 spring MVC Porject만들기
   ...
   <img src="../../imgs/spring/install_4.png" style="border:3px solid black;border-radius:9px;width:600px">   
   File 메뉴에서 Other를 선택합니다.   

   <img src="../../imgs/spring/install_5.png" style="border:3px solid black;border-radius:9px;width:600px">   
   legacy로 검색을 합니다. 
   ...
   <img src="../../imgs/spring/install_6.png" style="border:3px solid black;border-radius:9px;width:600px">   
   Spring Tools 3 Add-On for Spring Tools 4 를 선택합니다.   

   <img src="../../imgs/spring/install_7.png" style="border:3px solid black;border-radius:9px;width:600px">   
   모든 항목을 선택 후 Confirm을 선택합니다.   

   플로그인 설치 후에 에러가 발생합니다.   
   <img src="../../imgs/spring/sts3_error.png" style="border:3px solid black;border-radius:9px;width:600px">   
