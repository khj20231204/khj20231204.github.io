...
1. # flex-Container속성 : align-item
   플렉스 박스의 교차 축 설정. 주축에서 + 모양으로 그렸을 때 교차되는 축이 교차 축의 기준으로 item들이 이 교차 축을 기준으로 위치하게 돕니다.   
   ...
   <p class="codepen" data-height="600" data-default-tab="html,result" data-slug-hash="zYXaLJo" data-user="khj99" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
