...
1. # flex Container속성 : justify-content
   ...
   <p class="codepen" data-height="300" data-default-tab="html,result" data-slug-hash="oNOyyab" data-user="khj99" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
   ...
   flex-start는 가장 왼쪽   
   center는 가운데   
   flex-end는 가장 오른쪽에 위치가 됩니다.   

   direction:column인 경우 주축이 세로가 됩니다.   
   flex-start는 세로 축을 기준으로 가장 위   
   center는 가운데   
   flex-end는 가장 아랫쪽에 위치합니다.   

1. # flex-Container속성 : align-item
   
      

   <p class="codepen" data-height="300" data-default-tab="html,result" data-slug-hash="zYXaLJo" data-user="khj99" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
   <span>See the Pen <a href="https://codepen.io/khj99/pen/zYXaLJo">
   ch05.flex_align_content</a> by kimhyunjin (<a href="https://codepen.io/khj99">@khj99</a>)
   on <a href="https://codepen.io">CodePen</a>.</span>
   </p>
   <script async src="https://cpwebassets.codepen.io/assets/embed/ei.js"></script>
