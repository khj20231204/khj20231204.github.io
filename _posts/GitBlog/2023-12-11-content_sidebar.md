...
1. # 블로그 생성부터 우분투에 연결까지
   ...
   <img src="../../imgs/gitblog/sidebar_fork.png" style="border:3px solid black;border-radius:9px;width:600px">   
   ...
   <img src="../../imgs/gitblog/sidebar_ssh.png" style="border:3px solid black;border-radius:9px;width:600px">   
   ...
   블로그 실행   
   <img src="../../imgs/gitblog/sidebar_first_blog.png" style="border:3px solid black;border-radius:9px;width:600px">   

   확인하기 위해서 임시로 SQL파일과 우분투 파일을 넣음   
   <img src="../../imgs/gitblog/sidebar_temp_data.png" style="border:3px solid black;border-radius:9px;width:600px">   
...
1. # 사이드바 생성 
   ...
   <img src="../../imgs/gitblog/sidebar_make_pages.png" style="border:3px solid black;border-radius:9px;width:600px">    
   ...
   ```s
      ...
      - title: 프로그래밍
         children:
            ...
            url: /Ubuntu          
   ```   
   <img src="../../imgs/gitblog/sidebar_navigation.png" style="border:3px solid black;border-radius:9px;width:600px">    
   씌워쓰기와 앞 줄 간격 맞추는 걸 주의해야합니다. url: /sql은 _pages디렉토리 안에서 permalink가 /sql인 페이지로 연결되게 됩니다.   
   ...
   <img src="../../imgs/gitblog/sidebar_show1.png" style="border:3px solid black;border-radius:9px;width:600px">   
   ...
   <img src="../../imgs/gitblog/sidebar_index.png" style="border:3px solid black;border-radius:9px;width:600px">   

   홈에서도 목록이 보입니다.   
   <img src="../../imgs/gitblog/sidebar_home.png" style="border:3px solid black;border-radius:9px;width:600px">   