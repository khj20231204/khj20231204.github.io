...
1. # 블로그 생성부터 우분투에 연결까지
   ...
   <img src="../../imgs/gitblog/sidebar_temp_data.png" style="border:3px solid black;border-radius:9px;width:500px">   
...
1. # 사이드바 생성 
   ...
   <img src="../../imgs/gitblog/sidebar_make_pages.png" style="border:3px solid black;border-radius:9px;width:500px">    
